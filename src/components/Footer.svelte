...
<footer class="relative flex justify-between items-center mx-7 mt-16 py-6 border-t border-sky-300/40 dark:border-amber-400/20">
  <span class="flex items-center gap-1.5 text-slate-600 dark:text-slate-400 text-sm font-medium">
    Built with
    <span aria-label="love" class="inline-block text-rose-500 animate-heartbeat">
      ♥
    </span>
    by Shaharyar Shakir
  </span>
  ...
  <div class="flex items-center gap-5">
    <a
      ...
      rel="noopener"
      aria-label="GitHub"
      class="flex items-center text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-all hover:-translate-y-0.5 duration-200"
    >
